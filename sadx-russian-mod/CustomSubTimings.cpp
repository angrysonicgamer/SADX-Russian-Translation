...
{
	CutsceneDataList[0x0006]->Function = ev0006_s_poolsidewithtails_tw;
	CutsceneDataList[0x0008]->Function = ev0008_s_chaos1_tw;
	CutsceneDataList[0x000C]->Function = ev000C_s_afterchaos4_tw;
	CutsceneDataList[0x0012]->Function = ev0012_s_meetingamy_tw;
	CutsceneDataList[0x0013]->Function = ev0013_s_beforetwinklepark_tw;
	CutsceneDataList[0x001C]->Function = ev001C_s_beforechaos6_tw;
	//CutsceneDataList[0x001D]->Function = ev001D_s_afterchaos6_tw;
	...
	CutsceneDataList[0x00D8]->Function = ev00D8_b_eggcarrier_tw;
