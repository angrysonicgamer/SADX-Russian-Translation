...
const char* MissionsRus[]
{
	...
	/* 11 */ "Разбей ветряные мельницы\nи продвинься дальше...\nДостань шар, что парит над землёй!",
	...
	/* 40 */ "Что находится там,\nкуда смотрит огромная змея?",
...
HintMessageString AboutNameMachine[] = {
	...
	{ "\aПросим называть Чао милыми именами!", 0 } ,
	{ 0 }
};
