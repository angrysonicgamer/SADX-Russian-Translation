...
void ev0024_s_eggviper_tw(int state)
{
	...
	case 1:
		...
		EV_Wait(60);
		EV_SerifPlay(2049);
		EV_Msg(msgTbl_ev0024[TextLanguage][0]); //"\aDamn you, Sonic!"
		EV_Wait(1);
		EV_SerifWait();
		EV_SerifPlay(2050);
		EV_Msg(msgTbl_ev0024[TextLanguage][1]); //"\aHow dare you always, always,\nalways, always stand in my way!"
		EV_Wait(1);
		EV_SerifWait();
		EV_Wait(20);
		EV_SerifPlay(2051);
		EV_Msg(msgTbl_ev0024[TextLanguage][2]); //"\aAnd this time..."
		EV_Wait(1);
		EV_SerifWait();
		EV_SerifPlay(2052);
		EV_Msg(msgTbl_ev0024[TextLanguage][3]); //"\aYou destroyed the Egg Carrier..."
		EV_Wait(1);
		EV_SerifWait();
		EV_Wait(20);
		EV_SerifPlay(2053);
		EV_Msg(msgTbl_ev0024[TextLanguage][4]); //"\aYou defeated Chaos..."
		EV_Wait(1);
		EV_SerifWait();
		EV_Wait(15);
		EV_SerifPlay(2054);
		EV_Msg(msgTbl_ev0024[TextLanguage][5]); //"\aNot to mention you're even\nleading my base to ruin...!"
		EV_Wait(1);
		EV_SerifWait();
		EV_Wait(30);
		EV_SerifPlay(2055);
		EV_Msg(msgTbl_ev0024[TextLanguage][6]); //"\aIf that's how it is,\nI'll show you the ace up my sleeve!"
		EV_Wait(1);
		EV_SerifWait();
		EV_SerifPlay(2056);
		EV_Msg(msgTbl_ev0024[TextLanguage][7]); //"\aYou're finished this time,\nSonic!"
		EV_Wait(1);
		EV_SerifWait();
