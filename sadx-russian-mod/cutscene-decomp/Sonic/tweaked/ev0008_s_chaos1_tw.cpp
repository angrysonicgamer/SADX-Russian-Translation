...
void ev0008_s_chaos1_tw(int state)
{
	...
	case 1:
		...
		EV_MovePoint2(tails, 983.79999f, 126.5f, 848.70001f, 0.3f, 0.059999999f);
		EV_Wait(1);
		moveObjectOn(C_EME_P, -0.48f, 0.0f, 0.48f, -1, tails);
		...
		EV_Wait(5);
		ChgEggMobleMod(5);
		EV_Wait(7); // Emerald action delay
