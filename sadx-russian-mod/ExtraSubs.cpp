...
std::map<int, SubtitleData> ExtraSubs
{
	...
	{ 1767, { "\aВсе системы в норме.", 150, Menu } }, //Gamma
	...
	{ 394, { "\aК бою готов.", 180, Gameplay } }, //Gamma
	...
	{ 291, { "\aГород с видом на море...\nЭто так классно!", 210, Gameplay } }, //Amy
	...
	{ 286, { "\aЧувствую себя как крыса!", 120, Gameplay } }, //Sonic
	...
	{ 311, { "\aПровожу исследование\nМистических руин...", 180, Gameplay } }, //Gamma
	...
	{ 330, { "\aПодходящие данные отсутствуют.\nМестоположение неизвестно.", 360, Gameplay } }, //Gamma

	//Past (fire)

	{ 331, { "\aКакой кошмар!", 60, Gameplay } }, //Sonic
	...
	{ 336, { "\aИнтересно, зачем он построил это?", 210, Gameplay } }, //Amy
	...
	{ 238, { "\aНу и вонища...\nЧто это за свалка такая?", 180, Gameplay } }, //Sonic

	//Icecap

	{ 239, { "\aУх-х... Такая холодрыга!", 120, Gameplay } }, //Sonic
	...
	{ 247, { "\aИнтересно, куда делся Соник?", 150, Gameplay } }, //Amy

	//Speed Highway

	{ 248, { "\aЛады... Погнали!", 120, Gameplay } }, //Sonic
	{ 249, { "\aГде Эггман?", 60, Gameplay } }, //Tails
	{ 250, { "\aЭй-эй, некогда развлекаться!", 180, Gameplay } }, //Sonic
	...
	{ 270, { "\aЭггман, ну ты и подлец!", 150, Gameplay } }, //Amy
	{ 271, { "\aИнтересно, с Лягушиком\nвсё в порядке?", 210, Gameplay } }, //Big
	{ 272, { "\aА-а, и куда теперь?", 120, Gameplay } }, //Amy
	...
	{ 388, { "\aЯ покажу тебе\nистинную силу Изумрудов!", 210, Gameplay } },
	...
	{ 351, { "\aПрихожу сюда,\nи на душе сразу так легко!", 210, Gameplay } },
	{ 352, { "\aРебятки, как поживаете?", 120, Gameplay } },
	{ 353, { "\aЯ тоже вас всех люблю!", 120, Gameplay } },

	//Knuckles

	{ 354, { "\aПохоже, осколков здесь нет...", 150, Gameplay } },
	...
	{ 1902, { "\aМу-ха-ха-ха-ха-ха-ха-ха!\nСоник! Попробуй достань меня!", 300, Gameplay } }, //Egg Viper
	...
	{ 1726, { "\aПроклятый ёж! Я стряхну тебя!", 300, Gameplay } }, //Eggman ship tilt
